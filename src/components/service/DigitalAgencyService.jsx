...
import Service11 from "../../../public/assets/imgs/service/attendance.png";
import Service12 from "../../../public/assets/imgs/service/fnf.png";
import Service13 from "../../../public/assets/imgs/service/socialpillow.png";
import Service14 from "../../../public/assets/imgs/service/ml.png";
          ...
          <div className="row">
            <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-4">
              <div className="sec-title-wrapper wrap">
                <h2 className="sec-sub-title title-anim">Portfolio</h2>
